...
class BaseOptions(object):
    ...
    def parse(self):
        ...
        if a_feat_dirs != None:
            a_feat_dirs = [os.path.join(base_path, path) for path in a_feat_dirs]
        if t_feat_dir_pretrain_eval != None:
            t_feat_dir_pretrain_eval = os.path.join(base_path, t_feat_dir_pretrain_eval)
